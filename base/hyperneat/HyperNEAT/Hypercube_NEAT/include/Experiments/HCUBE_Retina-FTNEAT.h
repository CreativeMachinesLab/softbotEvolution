#ifndef HCUBE_RETINA_FTNEAT_H_INCLUDED
#define HCUBE_RETINA_FTNEAT_H_INCLUDED

#include "Experiments/HCUBE_Experiment.h"

//#define RETINA_FTNEAT_EXPERIMENT_DEBUG


namespace HCUBE
{
    class RetinaFTExperiment : public Experiment
    {
    public:
    protected:
	...
	int fitnessFunction, cutLinksThatCrossAxisX;
	double spreadInputsAxisX;
	double zeroOutHalfWidth;


    public:
        RetinaFTExperiment(string _experimentName);

        virtual ~RetinaFTExperiment()
        {}
    ...
    class RetinaFTNEATStats : public NEAT::Stringable
    {
    public:
...
//            oss << (numWrong*10000)/actualLocation.size()/100.0;  //actuallocation and targetlocation vectors should be removed
        ...
        {
            return new RetinaFTNEATStats(*this);
        }
    };
}

#endif // HCUBE_RETINA_FTNEAT_H_INCLUDED
